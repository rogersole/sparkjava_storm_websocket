...
/**
 * A RabbitMQ spout that emits an unanchored tuple stream on default stream. Should be used when
 * Storm's guaranteed message processing is not needed. Messages will be removed from RabbitMQ queue
 * as soon as it's delivered to storm and will not be retried on any errors during processing.
 *
