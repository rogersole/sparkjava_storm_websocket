...
/**
 * This is a simple {@link Bolt} for producing messages to RabbitMQ from a Storm topology. It needs
 * a {@link TupleToMessage} object to perform the real meat of converting the incoming {@link Tuple}
 * from a stream into a {@link Message} to publish on RabbitMQ.
 * 
 * @author bdgould
 *
 */
