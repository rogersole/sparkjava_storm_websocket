...
public class ConnectionConfig implements Serializable {
    ...
    public static ConnectionConfig forTest() {
        return new ConnectionConfig(ConnectionFactory.DEFAULT_HOST, ConnectionFactory.DEFAULT_USER,
    ...
    /**
     * Use this constructor if you wish to specify a set of hosts to connect to in the event that
     * you need a high availability RabbitMQ connection.
     * 
     * @param hosts The {@link ConfigAvailableHosts} that will give you the ability to specify a set
     *        of hosts
     * @param username
     * @param password
     * @param virtualHost
    ...
    /**
     * Set this value if you want to use a set of high availability hosts in addition to the
     * specified primary host you want to connect to, and didn't use the full constructor.
     * 
