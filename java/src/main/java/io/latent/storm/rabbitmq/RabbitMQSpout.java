...
/**
 * A simple RabbitMQ spout that emits an anchored tuple stream (on the default stream). This can be
 * used with Storm's guaranteed message processing.
 * 
...
public class RabbitMQSpout extends BaseRichSpout {
    ...
    private List<Object> extractTuple(Message message) {
        ...
        try {
            ...
            if (tuple != null && !tuple.isEmpty()) { return tuple; }
        ...
        // get the malformed message out of the way by dead-lettering (if dead-lettering is
