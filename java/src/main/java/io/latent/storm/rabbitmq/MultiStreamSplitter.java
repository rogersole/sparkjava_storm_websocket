...
public interface MultiStreamSplitter extends Serializable {
    ...
    /**
     * Given the tuple (the de-serialized message contents) and the message in its original
     * serialized format, select the stream this particular tuple should be emitted under.
     *
     * @param tuple the de-serialized form of message as a list of objects (a tuple)
     * @param message the original RabbitMQ message before it was de-serialized (incl. amqp envelope
     *        information)
